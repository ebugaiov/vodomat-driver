...
export default function LoginForm() {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center px-6">
            <div className="w-full max-w-md rounded-lg bg-gray-900/70 p-8 shadow-lg">
                ...
                <form ref={formRef} action={formAction} className="space-y-6">
                    <div>
                        ...
                        <div className="relative">
                            <input
                                className="peer block w-full rounded-md border border-gray-600 bg-gray-800 py-3 pl-10 text-sm text-white placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-blue-500"
                                id="username"
                                type="text"
                                name="username"
